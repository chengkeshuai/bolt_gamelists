      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-gray-300 hover:text-cyan-400 transition">{t('nav.home')}</a>
            <a href="#games" className="text-gray-300 hover:text-cyan-400 transition">{t('nav.games')}</a>
            <a href="#features" className="text-gray-300 hover:text-cyan-400 transition">{t('nav.features')}</a>
            <button
